...
<p class="text-sm font-light text-gray-600 dark:text-gray-400" style={{ marginLeft: '65px', marginTop: '-6px', fontSize: '0.675rem' }}>Mar 10, 2019</p>
...
<h6 class="loca" style={{ marginLeft: '4px', marginTop: '-3px', fontSize: '0.875rem' }}> {location} </h6>
