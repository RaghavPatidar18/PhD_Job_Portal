...
function Footer() {
  ...
  return (
    ...
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    <div>
                        <h3 style={{textAlign : 'left'}} class="text-gray-700 uppercase dark:text-black">About</h3>
                    ...
                    {/* <div>
                        <h3 class="text-gray-700 uppercase dark:text-black">Blog</h3>
                    ...
                    <div>
                        <h3 style={{textAlign : 'left'}}class="text-gray-700 uppercase dark:text-black">Products</h3>
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">PHD Job Portal</a>
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">PHD Admission</a>
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">PHD research Grant</a>
                    </div>

                    <div>
                        <h3 style={{textAlign : 'left'}}class="text-gray-700 uppercase dark:text-black">Contact</h3>
        ...
        <hr class="h-px my-6 bg-gray-200 border-none dark:bg-gray-700"></hr>
